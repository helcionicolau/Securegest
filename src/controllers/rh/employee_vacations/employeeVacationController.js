const FuncionarioFerias = require('../../../models/rh/employee_vacations/employeeVacation'); // Importe o modelo correto
const Funcionario = require('../../../models/rh/employees/Employee'); // Importe o modelo de funcionários
const { Op } = require('sequelize');

// Registrar uma nova solicitação de férias
exports.registrarFerias = async (req, res) => {
    ...
    try {
        ...
        const novaSolicitacao = await FuncionarioFerias.create({
            id_funcionario,
            tipo_ferias,
            data_inicio,
            data_fim,
...
// Atualizar uma solicitação de férias existente
exports.updateFuncionarioFerias = async (req, res) => {
    ...
    try {
        const solicitacao = await FuncionarioFerias.findByPk(feriasId);
        if (!solicitacao) {
...
// Listar todas as solicitações de férias
exports.listarTodasFerias = async (req, res) => {
    try {
        const ferias = await FuncionarioFerias.findAll();
        res.json(ferias);
    } catch (error) {
        console.error(error);
...
// Aprovar ou rejeitar uma solicitação de férias
exports.aprovarRejeitarFerias = async (req, res) => {
...
// Consultar o saldo atual de férias para um funcionário específico
exports.consultarSaldoFerias = async (req, res) => {
    ...
    try {
        ...
        const feriasAprovadas = await FuncionarioFerias.findAll({
            where: {
...
// Consultar detalhes de uma solicitação de férias por ID
exports.getFuncionarioFeriasById = async (req, res) => {
...
// Excluir uma solicitação de fériass
